...
def format_email_content(message, restaurants):
    email_content = f"Hello! Here are my {message['cuisine']} restaurant suggestions for {message['numberofpeople']} people, for {message['date']} at {message['time']}\n"
